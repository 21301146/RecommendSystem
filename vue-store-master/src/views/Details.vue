      ...
      <div class="title">
        ...
        <div class="list">
          <ul>
            ...
            <li>
              <router-link
                :to="{ path: '/commentsList', query: { productID: this.$route.query.productID } }">评价列表</router-link>
            </li>
            <li>
              <router-link :to="{ path: '/comments', query: { productID: this.$route.query.productID } }"
                @click="navigateToComments">用户评价</router-link>
            </li>
          </ul>
        </div>
      </div>
